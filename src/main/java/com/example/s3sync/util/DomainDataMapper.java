 ...
 *
 * <p>This utility provides simple, deterministic mapping functions that transform domain objects
 * into the DTOs used for CSV export. The mapping preserves the field ordering expected by the CSV
 * writer.
 */
public class DomainDataMapper {
   ...
   *
   * <p>Order ids and customer ids are kept as strings to match the CSV schema expected by the
   * consumer.
   *
