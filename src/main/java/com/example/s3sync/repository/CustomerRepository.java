 ...
 * pagination for {@code Customer} entities. Additional query methods (if needed) can be declared
 * here following Spring Data's method name conventions or using {@code @Query} annotations.
 */
