 ...
 *
 * <p>
 * This service wraps an {@link S3Client} and provides convenience methods
 * to upload and delete objects in the configured bucket. It's used by the
 * synchronization pipeline to persist CSV exports.
 * </p>
 *
 * <p>
 * Configuration:
 * <ul>
 * <li><code>aws.s3.bucket</code> - target bucket for CSV uploads</li>
 * </ul>
 * </p>
 *
 * <p>
 * Notes:
 * <ul>
 * <li>Uploaded objects are set with content type <code>text/csv</code>.</li>
 * <li>The upload method returns the S3 ETag which can be used as a
 * lightweight verification token.</li>
 * </ul>
 * </p>
 */
@Slf4j
...
public class S3UploaderService {
    ...
    /**
     * Target S3 bucket, injected from application properties
     ...
     *
     * <p>
     * The uploaded object will be stored in the configured bucket with
     * content type <code>text/csv</code>. This method returns the ETag
     * reported by S3 which can be used as a simple verification or logging
     * token.
     * </p>
     *
     ...
     * @throws software.amazon.awssdk.core.exception.SdkException if the upload
     *                                                            fails at the SDK
     *                                                            level
     */
     ...
     *
     * <p>
     * On SDK-level failures an
     * {@link software.amazon.awssdk.core.exception.SdkException}
     * is propagated. Other unexpected exceptions are re-thrown as well after
     * being logged.
     * </p>
     *
