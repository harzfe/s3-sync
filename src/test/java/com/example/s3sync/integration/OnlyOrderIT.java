...
public class OnlyOrderIT extends BaseIT {
                ...
                /**
                 * Integration test that verifies when only orders are unsynced (customers
                 * already tracked), the job uploads an orders CSV for the customer's
                 * country and does not upload a customer CSV. Also verifies the tracked
