...
class NoCustomerNoOrderIT extends BaseIT {
        ...
        /**
         * Integration test that verifies when all customers and orders are already
         * tracked (synced), the job does not upload customer or order CSVs and
         * the counts of tracking entries remain unchanged.
         */
        @Test
