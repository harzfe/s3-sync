...
class SyncJobTest {
  ...
  @Mock SyncDiffService syncDiffService;
  @Mock CustomerSyncService customerSyncService;
  @Mock OrderSyncService orderSyncService;

  @InjectMocks private SyncJob job;

  /**
   * When there are unsynced customers and orders, the job should delegate to both
   * CustomerSyncService and OrderSyncService to process and upload the respective CSVs.
   */
  @Test
  ...
  /**
   * If there are no unsynced customers but unsynced orders exist, only the OrderSyncService should
   * be invoked; CustomerSyncService must not be called.
   */
  @Test
  ...
  /**
   * If there are no unsynced orders but unsynced customers exist, only the CustomerSyncService
   * should be invoked; OrderSyncService must not be called.
   */
  @Test
  ...
  /**
   * When there are no unsynced customers nor orders the job should perform no interactions with the
   * sync services.
   */
  @Test
